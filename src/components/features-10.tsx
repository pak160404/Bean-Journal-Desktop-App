...
import image from '@/images/feature1.png'
            ...
            <div className="mx-auto max-w-2xl px-6 lg:max-w-5xl">
                ...
                <FeatureCard>
                        ...
                        <div className="relative mb-6 border-t border-dashed sm:mb-0">
                            <div className="absolute inset-0 [background:radial-gradient(125%_125%_at_50%_0%,transparent_40%,hsl(var(--color-main)),hsl(var(--color-white))_100%)]"></div>
                            <div className="aspect-76/59 p-2 px-3">
                                <DualModeImage
                                    darkSrc={image}
                                    lightSrc={image}
                    ...
                    <FeatureCard>
                        ...
                        <CardContent>
                            <div className="relative mb-6 sm:mb-0">
                                <div className="absolute -inset-6 [background:radial-gradient(50%_50%_at_75%_50%,transparent,hsl(var(--color-background)_100%))]"></div>
...
const CardDecorator = () => (
    <>
        <span className="border-black absolute -left-px -top-px block size-2 border-l-2 border-t-2"></span>
        <span className="border-black absolute -right-px -top-px block size-2 border-r-2 border-t-2"></span>
        <span className="border-black absolute -bottom-px -left-px block size-2 border-b-2 border-l-2"></span>
        <span className="border-black absolute -bottom-px -right-px block size-2 border-b-2 border-r-2"></span>
    </>
)
