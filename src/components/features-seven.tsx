                ...
                <div className="mx-auto w-full max-w-5xl px-6">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                        <Card
                            ...
                            <h3 className="text-foreground mt-5 text-lg font-semibold">AI Mood Detection</h3>
                            <p className="mt-3 max-w-xl text-balance">Our advanced AI accurately detects and analyzes mood patterns from your journal entries, offering valuable insights into your emotional well-being.</p>
                        ...
                        <Card
                            ...
                            <h3 className="text-foreground mt-5 text-lg font-semibold">AI Journal to Video</h3>
                            <p className="mt-3 text-balance">Automatically transform your journal entries into compelling video narratives, bringing your memories to life.</p>
                        ...
                        <Card
                            ...
                            <h3 className="text-foreground mt-5 text-lg font-semibold">Enhanced Productivity</h3>
                            <p className="mt-3 text-balance">Boost your efficiency with AI-powered tools designed to streamline your journaling and content creation process.</p>
                        ...
                        <Card
                            ...
                            <p className="mt-3 text-balance">A personalized AI companion that understands your journaling context and helps you articulate thoughts, summarize entries, and more.</p>
