...
const featuresData = [
  {
    ...
    description: "Experience blazing-fast performance and seamless interactions with our optimized platform.",
  },
  {
    icon: <CheckCircle className="h-8 w-8 text-primary" />,
    title: "Easy to Use",
    description: "Our intuitive interface makes it simple for anyone to get started and achieve their goals.",
  },
  {
  ...
  },
   {
    ...
    description: "Your data is protected with industry-leading security measures and protocols.",
  },
  {
    icon: <CheckCircle className="h-8 w-8 text-primary" />,
    title: "24/7 Support",
    description: "Get help whenever you need it with our dedicated round-the-clock customer support.",
  },
  {
    icon: <BarChart className="h-8 w-8 text-primary" />,
    title: "Scalable Solution",
    description: "Our platform grows with your needs, ensuring reliability and performance at any scale.",
  },
];
    ...
    <Card className="bg-card/70 backdrop-blur-md shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 border border-border/50">
      <CardHeader className="items-center text-center pt-6 pb-4">
        <div className="p-3 rounded-full bg-primary/10 mb-3 inline-block">
          ...
          {icon && React.cloneElement(icon as React.ReactElement, { className: "h-10 w-10 text-primary" })}
        </div>
    ...
    <div className="landing-page-theme min-h-screen bg-gradient-to-b from-background via-background to-muted/20 text-foreground relative overflow-x-hidden">
      ...
      <div className="text-center mt-[10rem] mb-[5rem]">
          ...
          <p className="text-xl mt-4 max-w-2xl mx-auto">
            Our platform is packed with powerful features designed to streamline your workflow and boost your productivity.
          </p>
        </div>
      <FeaturesSection2 />
      <FeaturesSection />
      ...
      <main className="relative z-20 bg-background shadow-2xl_top_inner_heavy">
        

        {/* Testimonials Section - Wrapped to apply custom className */}
